...
export const ZONAS_UI = {
  ...
  hero: {
    nombre: 'Hero',
    descripcion: 'Destaca tu mensaje principal con una imagen o botón que llame la atención',
    icono: '<rect x="3" y="4" width="18" height="16" rx="2"/><rect x="7" y="8" width="10" height="6" rx="1"/><path d="M9 17h6"/>',
  },
  contenido: {
    nombre: 'Contenido',
